...
from . import auth, faceit_oauth, feedback, overlay, profiles, support, views
from .apikeys import require_api_key

urlpatterns = [
    path("support/ticket/", support.create_ticket, name="support-create"),
    path("support/lookup/", support.lookup_ticket, name="support-lookup"),
    path("support/reply/", support.reply_ticket, name="support-reply"),
    ...
    path("player/<str:nickname>/", require_api_key(views.player_summary), name="player-summary"),
    ...
    path("player/<str:nickname>/csrep/refresh/", views.csrep_refresh, name="player-csrep-refresh"),
    path("csrep/match/", views.csrep_match, name="csrep-match"),
    path("csrep/players/", views.csrep_players, name="csrep-players"),
    path("csrep/search/", views.csrep_search, name="csrep-search"),
    ...
    path("match/<str:match_id>/", require_api_key(views.match_detail), name="match-detail"),
    ...
    path("bans/", require_api_key(views.recent_bans), name="recent-bans"),
    path("matchroom/", require_api_key(views.match_room), name="match-room"),
    ...
    path("squad/", require_api_key(views.squad_stats), name="squad-stats"),
    path("search/", require_api_key(views.search), name="search"),
    path("recent/", require_api_key(views.recent), name="recent"),
    path("leaderboard/", require_api_key(views.leaderboard), name="leaderboard"),
    path("leaderboard/countries/", require_api_key(views.leaderboard_countries), name="leaderboard-countries"),
    path("analyze/<str:nickname>/", views.analyze, name="analyze"),
    path("roast/<str:nickname>/", views.roast, name="roast"),
    path("met/", require_api_key(views.have_we_met), name="have-we-met"),
