...
export const UI = {
  en: {
    ...
    "nav.support": "Support", "hint.support": "Tickets and API access",
    ...
    "tab.overview": "Overview", "tab.matches": "Matches", "tab.maps": "Maps",
    "tab.hubs": "Hubs", "tab.highlights": "Highlights",
    "tab.activity": "Activity", "tab.compare": "Compare", "tab.bans": "Bans",
    "tab.trust": "Trust", "tab.leetify": "Leetify", "tab.csrep": "CSRep",
  ...
  ru: {
    ...
    "nav.support": "Поддержка", "hint.support": "Тикеты и доступ к API",
    ...
    "tab.overview": "Обзор", "tab.matches": "Матчи", "tab.maps": "Карты",
    "tab.hubs": "Хабы", "tab.highlights": "Рекорды",
    "tab.activity": "Активность", "tab.compare": "Сравнить", "tab.bans": "Баны",
    "tab.trust": "Доверие", "tab.leetify": "Leetify", "tab.csrep": "CSRep",
  ...
  pl: {
    ...
    "nav.support": "Wsparcie", "hint.support": "Zgłoszenia i dostęp do API",
    ...
    "tab.overview": "Przegląd", "tab.matches": "Mecze", "tab.maps": "Mapy",
    "tab.hubs": "Huby", "tab.highlights": "Rekordy",
    "tab.activity": "Aktywność", "tab.compare": "Porównaj", "tab.bans": "Bany",
    "tab.trust": "Zaufanie", "tab.leetify": "Leetify", "tab.csrep": "CSRep",
  ...
  uk: {
    ...
    "nav.support": "Підтримка", "hint.support": "Тікети та доступ до API",
    ...
    "tab.overview": "Огляд", "tab.matches": "Матчі", "tab.maps": "Карти",
    "tab.hubs": "Хаби", "tab.highlights": "Рекорди",
    "tab.activity": "Активність", "tab.compare": "Порівняти", "tab.bans": "Бани",
    "tab.trust": "Довіра", "tab.leetify": "Leetify", "tab.csrep": "CSRep",
...
export const PAGE_META_I18N = {
  ru: {
    ...
    overlay: ["Бесплатный оверлей FACEIT для OBS — Faceit-Lens",
      "Живая карточка с ELO, счётом сессии и текущим матчем для вашего стрима. Бесплатно, без установки, работает в любом Browser Source в OBS."],
    ...
    support: ["Поддержка и доступ к API — Faceit-Lens",
      "Сообщить об ошибке, попросить исправить данные или запросить ключ API. Через тикеты, аккаунт не нужен."],
  ...
  pl: {
    ...
    overlay: ["Darmowa nakładka FACEIT na stream do OBS — Faceit-Lens",
      "Karta z ELO na żywo, bilansem sesji i trwającym meczem na Twój stream. Za darmo, bez instalacji, działa w każdym Browser Source w OBS."],
    ...
    support: ["Wsparcie i dostęp do API — Faceit-Lens",
      "Zgłoś błąd, poproś o poprawienie danych albo o klucz API. Przez zgłoszenia, bez zakładania konta."],
  ...
  uk: {
    ...
    overlay: ["Безкоштовний оверлей FACEIT для OBS — Faceit-Lens",
      "Жива картка з ELO, рахунком сесії та поточним матчем для вашого стріму. Безкоштовно, без встановлення, працює в будь-якому Browser Source в OBS."],
    ...
    support: ["Підтримка та доступ до API — Faceit-Lens",
      "Повідомити про помилку, попросити виправити дані або запросити ключ API. Через тікети, акаунт не потрібен."],
